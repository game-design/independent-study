...
namespace SimpleJSON
{
	...
	public abstract class JSONNode
	{
		...
		public virtual int? AsInt
		{
			get {
				...
				if (int.TryParse (Value, out v))
					return v;
				return null; //jbw says was 0
			}
			set {
				if(value == null) //jbw
				{ //jbw
					Value = null; //jbw
					Tag = JSONBinaryTag.Value; //jbw
				} //jbw
				else //jbw
				{	//jbw
		...
		public virtual bool? AsBool
		{
			get {
				...
				if (bool.TryParse (Value, out v))
					return v;
				//jbw return !string.IsNullOrEmpty (Value);
				return null; //jbw
			}
			set {
				if(value == null) //jbw
		...
		//jbw says this looks like it could be a problem regarding support of null value
	...
	public class JSONData : JSONNode
	{
		...
		public JSONData (float? aData) //jbw
		{
			AsFloat = aData;
		}
		
		public JSONData (double? aData) //jbw
		{
			AsDouble = aData;
		}
		
		public JSONData (bool? aData) //jbw
		{
			AsBool = aData;
		}
		
		public JSONData (int? aData) //jbw
		{
			AsInt = aData;
		}
		...
		public override string ToString (string aPrefix)
		{
			//jbw says this method looks suspect. what is aPrefix for?
